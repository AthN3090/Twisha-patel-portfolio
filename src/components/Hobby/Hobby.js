...
function Hobby() {
    ...
    <section className="bg-[#242424] ">
        <div className="py-10 text-white  font-semibold text-4xl text-center border-b border-[#A2A2A2]">
            Hobby Projects
        </div>
        <div className="flex justify-between min-h-screen">
            <div className="w-[240px] border-r border-[#A2A2A2] ">
            ...
            <div className="grid grid-cols-2 h-fit gap-[1px] bg-[#A2A2A2]">
            ...
            <div className="w-[240px] border-l border-[#A2A2A2]">
            <div className="flex flex-col items-center gap-32 text-white py-10">
                    <p className="text-8xl rotate-180 relative" style={{writingMode: 'vertical-lr', WebkitTextFillColor:"#242424", WebkitTextStrokeWidth: '1px', WebkitTextStrokeColor:"#A2A2A2"}}>
                        Illustrations
                    </p>
