      ...
      <div>
        ...
        >
          ...
          <div className='md:hidden p-5 flex justify-center'>
            <Image src="/images/mobile-landing.jpeg" height={420} width={500} alt="mobile-landing" ></Image>
          </div>
          <div className="flex max-w-[1280px] mx-auto items-center h-full p-5">
            <div className="flex flex-col justify-center max-w-[666px] lg:m-28 md:m-[10vw]">
              <p className="xl:text-3xl font-semibold md:text-[2vw] sm:text-md text-lg">Hi, I am Twisha Patel</p>
              <p className="font-semibold xl:text-7xl md:text-[4vw] text-4xl md:mt-7 mt-3 md:max-w-[300px] lg:max-w-[500px] xl:max-w-full">User Experience Designer</p>
              ...
              <a href="#" className="flex items-center transition-all gap-3 hover:gap-5 hover:underline md:mt-10 mt-3 border md:w-fit p-3 md:justify-normal justify-between border-[#828282]"> <span className="mt-[2px]">View my resume </span><Image src={"/images/right.svg"} alt="right-arrow" height={16} width={16}></Image> </a>
            </div>
