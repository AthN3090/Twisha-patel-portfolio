        ...
        <div className="max-w-[1440px] mx-auto bg-[#FAFAFA] min-h-screen pt-16 flex flex-col lg:flex-row font-epilogue">
          ...
          <div className="lg:w-1/2  lg:py-16 lg:px-20 px-4 py-4 border-r border-l">
            ...
            <p className="mt-4 leading-7 ">
              ...
              aura.&quot; I am a self-taught UX designer based in Gujarat,
              India. My journey in this field has been quite interesting. Even
              though I studied computer science, I soon discovered that my real
              love is UX Design. It&apos;s the perfect mix of solving problems
              and being creative.<br></br>
              <br></br>
